...
class GCodeGenerator:
    ...
    def generate(self, contours, image_width=0, image_height=0,
        ...
        if use_auto_scale:
            gcode_lines.append(f"; Original contour size: {orig_width:.1f} x {orig_height:.1f} pixels")
            gcode_lines.append(f"; Target size: {target_width} x {target_height} mm")
            gcode_lines.append(f"; Auto scale: {scale:.4f}")
            gcode_lines.append(f"; Centered in target area")
        else:
